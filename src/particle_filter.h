...
void particle_filter(struct particle particles[N], struct measurement *z, int use_variance);
void particle_filter_multiple(struct particle particles[N], struct measurement *z, struct measurement *z2);
